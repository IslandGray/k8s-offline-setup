...
# 导入镜像
# kubernetes
docker load -i ../images/kube-controller-manager-v1.21.0.tar
docker load -i ../images/kube-apiserver-v1.21.0.tar
docker load -i ../images/kube-scheduler-v1.21.0.tar
docker load -i ../images/kube-proxy-v1.21.0.tar
docker load -i ../images/coredns-1.8.0.tar
docker load -i ../images/etcd-3.4.13-0.tar
docker load -i ../images/pause-3.4.1.tar
